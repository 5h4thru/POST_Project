...
<center>
	...
	<h:form>
		<h:outputText value="Delete Form" />
		<h:panelGrid border="1" columns="2">
			<h:outputText value="User Name"></h:outputText>
			<h:selectOneMenu id="sel" value="#{bean.userName}" required="true" requiredMessage="Please select an employee">
				<f:selectItem itemLabel="--select--"/>
				<f:selectItems value="#{bean.namesList}" />
			</h:selectOneMenu>
		</h:panelGrid>
		<br>
		<h:commandButton value="Delete Employee" action="#{bean.delEmployee}"></h:commandButton>
		<br>
