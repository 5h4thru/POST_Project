...
public class LeavePhoneValidator implements Validator{
...
if(!(a==10))
{
	...
	FacesMessage message=new FacesMessage();
	message.setSummary("PhoneNo should be of 10 digits");
	message.setDetail("PhoneNo should be of 10 digits");
	throw new ValidatorException(message);
}
